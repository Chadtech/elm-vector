module Vector75.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector75 a
...
unshift : a -> Vector75 a -> Vector76 a
