module Vector32.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector32 a
...
unshift : a -> Vector32 a -> Vector33 a
