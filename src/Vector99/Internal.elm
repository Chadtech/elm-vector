module Vector99.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector99 a
...
unshift : a -> Vector99 a -> Vector100 a
