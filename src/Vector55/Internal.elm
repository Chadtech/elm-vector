module Vector55.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector55 a
...
unshift : a -> Vector55 a -> Vector56 a
