module Vector76.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector76 a
...
unshift : a -> Vector76 a -> Vector77 a
