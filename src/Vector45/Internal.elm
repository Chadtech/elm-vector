module Vector45.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector45 a
...
unshift : a -> Vector45 a -> Vector46 a
