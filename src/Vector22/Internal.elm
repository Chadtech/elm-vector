module Vector22.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector22 a
...
unshift : a -> Vector22 a -> Vector23 a
