...
{-| Make a `Vector7 a` using a function that takes an `Int`, representing the index -}
...
{-| Make a `Vector7 a` filled with just one item repeated over and over again. -}
repeat : a -> Vector7 a
repeat a =
    { n0 = a
    , n1 = a
...
{-| Make a `Vector7 a` from 7 elements -}
