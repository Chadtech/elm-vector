module Vector64.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector64 a
...
unshift : a -> Vector64 a -> Vector65 a
