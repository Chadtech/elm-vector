module Vector89.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector89 a
...
unshift : a -> Vector89 a -> Vector90 a
