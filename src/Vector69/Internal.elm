module Vector69.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector69 a
...
unshift : a -> Vector69 a -> Vector70 a
