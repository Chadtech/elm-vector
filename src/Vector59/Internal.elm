module Vector59.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector59 a
...
unshift : a -> Vector59 a -> Vector60 a
