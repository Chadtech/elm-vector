module Vector23.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector23 a
...
unshift : a -> Vector23 a -> Vector24 a
