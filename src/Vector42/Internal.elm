module Vector42.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector42 a
...
unshift : a -> Vector42 a -> Vector43 a
