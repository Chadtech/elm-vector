module Vector70.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector70 a
...
unshift : a -> Vector70 a -> Vector71 a
