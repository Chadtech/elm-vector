module Vector50.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector50 a
...
unshift : a -> Vector50 a -> Vector51 a
