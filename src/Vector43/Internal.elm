module Vector43.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector43 a
...
unshift : a -> Vector43 a -> Vector44 a
