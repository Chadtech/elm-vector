module Vector35.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector35 a
...
unshift : a -> Vector35 a -> Vector36 a
