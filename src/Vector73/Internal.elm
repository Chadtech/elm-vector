module Vector73.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector73 a
...
unshift : a -> Vector73 a -> Vector74 a
