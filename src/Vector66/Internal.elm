module Vector66.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector66 a
...
unshift : a -> Vector66 a -> Vector67 a
