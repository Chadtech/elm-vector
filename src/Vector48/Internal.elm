module Vector48.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector48 a
...
unshift : a -> Vector48 a -> Vector49 a
