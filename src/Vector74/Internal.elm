module Vector74.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector74 a
...
unshift : a -> Vector74 a -> Vector75 a
