module Vector51.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector51 a
...
unshift : a -> Vector51 a -> Vector52 a
