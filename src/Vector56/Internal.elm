module Vector56.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector56 a
...
unshift : a -> Vector56 a -> Vector57 a
