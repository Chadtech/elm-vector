module Vector78.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector78 a
...
unshift : a -> Vector78 a -> Vector79 a
