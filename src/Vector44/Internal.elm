module Vector44.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector44 a
...
unshift : a -> Vector44 a -> Vector45 a
