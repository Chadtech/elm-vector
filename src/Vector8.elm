module Vector8 exposing
    ( Vector8
    , fromList, repeat, from8, fromListWithDefault, initializeFromInt, initializeFromIndex
...
{-| a `Vector8 a` using a function that takes an `Int`, representing the index
-}
...
{-| a `Vector8 a` filled with just one item repeated over and over again.
-}
repeat : a -> Vector8 a
repeat a =
    { n0 = a
...
{-| A list of all the indices, from 0 to 7
-}
indices : Vector8 Index
indices =
