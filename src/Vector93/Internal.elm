module Vector93.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector93 a
...
unshift : a -> Vector93 a -> Vector94 a
