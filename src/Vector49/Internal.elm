module Vector49.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector49 a
...
unshift : a -> Vector49 a -> Vector50 a
