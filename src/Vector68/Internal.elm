module Vector68.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector68 a
...
unshift : a -> Vector68 a -> Vector69 a
