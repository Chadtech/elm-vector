module Vector88.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector88 a
...
unshift : a -> Vector88 a -> Vector89 a
