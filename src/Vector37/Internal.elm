module Vector37.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector37 a
...
unshift : a -> Vector37 a -> Vector38 a
