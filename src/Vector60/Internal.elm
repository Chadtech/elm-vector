module Vector60.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector60 a
...
unshift : a -> Vector60 a -> Vector61 a
