module Vector36.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector36 a
...
unshift : a -> Vector36 a -> Vector37 a
