module Vector52.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector52 a
...
unshift : a -> Vector52 a -> Vector53 a
