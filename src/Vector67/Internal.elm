module Vector67.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector67 a
...
unshift : a -> Vector67 a -> Vector68 a
