module Vector72.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector72 a
...
unshift : a -> Vector72 a -> Vector73 a
