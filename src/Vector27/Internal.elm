module Vector27.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector27 a
...
unshift : a -> Vector27 a -> Vector28 a
