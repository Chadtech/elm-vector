module Vector58.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector58 a
...
unshift : a -> Vector58 a -> Vector59 a
