module Vector30.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
import Vector30.Internal exposing (Vector(..), VectorModel)
...
fromListWithDefault : a -> List a -> Vector30 a
...
unshift : a -> Vector30 a -> Vector31 a
