module Vector38.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector38 a
...
unshift : a -> Vector38 a -> Vector39 a
