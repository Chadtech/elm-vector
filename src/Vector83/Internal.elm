module Vector83.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector83 a
...
unshift : a -> Vector83 a -> Vector84 a
