module Vector94.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector94 a
...
unshift : a -> Vector94 a -> Vector95 a
