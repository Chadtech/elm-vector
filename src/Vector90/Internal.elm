module Vector90.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector90 a
...
unshift : a -> Vector90 a -> Vector91 a
