module Vector31.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector31 a
...
unshift : a -> Vector31 a -> Vector32 a
