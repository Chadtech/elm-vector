module Vector57.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector57 a
...
unshift : a -> Vector57 a -> Vector58 a
