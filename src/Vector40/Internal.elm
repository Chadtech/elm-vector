module Vector40.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector40 a
...
unshift : a -> Vector40 a -> Vector41 a
