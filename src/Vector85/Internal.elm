module Vector85.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector85 a
...
unshift : a -> Vector85 a -> Vector86 a
