module Vector47.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector47 a
...
unshift : a -> Vector47 a -> Vector48 a
