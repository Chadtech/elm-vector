module Vector65.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector65 a
...
unshift : a -> Vector65 a -> Vector66 a
