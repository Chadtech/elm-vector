module Vector92.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector92 a
...
unshift : a -> Vector92 a -> Vector93 a
