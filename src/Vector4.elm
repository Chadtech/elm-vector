module Vector4 exposing
    ( Vector4
    , fromList, repeat, from4, fromListWithDefault, initializeFromInt, initializeFromIndex
...
{-| a `Vector4 a` using a function that takes an `Int`, representing the index
-}
...
{-| a `Vector4 a` filled with just one item repeated over and over again.
-}
repeat : a -> Vector4 a
repeat a =
    { n0 = a
