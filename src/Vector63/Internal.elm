module Vector63.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector63 a
...
unshift : a -> Vector63 a -> Vector64 a
