module Vector21.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector21 a
...
unshift : a -> Vector21 a -> Vector22 a
