module Vector71.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector71 a
...
unshift : a -> Vector71 a -> Vector72 a
