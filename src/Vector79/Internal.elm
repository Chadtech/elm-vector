module Vector79.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector79 a
...
unshift : a -> Vector79 a -> Vector80 a
