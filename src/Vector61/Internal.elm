module Vector61.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector61 a
...
unshift : a -> Vector61 a -> Vector62 a
