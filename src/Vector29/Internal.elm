module Vector29.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector29 a
...
unshift : a -> Vector29 a -> Vector30 a
