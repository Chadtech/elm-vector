module Vector46.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector46 a
...
unshift : a -> Vector46 a -> Vector47 a
