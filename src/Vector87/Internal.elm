module Vector87.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector87 a
...
unshift : a -> Vector87 a -> Vector88 a
