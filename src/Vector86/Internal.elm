module Vector86.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector86 a
...
unshift : a -> Vector86 a -> Vector87 a
