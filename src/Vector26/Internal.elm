module Vector26.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector26 a
...
unshift : a -> Vector26 a -> Vector27 a
