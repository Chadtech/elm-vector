module Vector54.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector54 a
...
unshift : a -> Vector54 a -> Vector55 a
