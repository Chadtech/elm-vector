module Vector96.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector96 a
...
unshift : a -> Vector96 a -> Vector97 a
