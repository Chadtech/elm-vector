module Vector33.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector33 a
...
unshift : a -> Vector33 a -> Vector34 a
