module Vector82.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector82 a
...
unshift : a -> Vector82 a -> Vector83 a
