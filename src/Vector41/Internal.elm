module Vector41.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector41 a
...
unshift : a -> Vector41 a -> Vector42 a
