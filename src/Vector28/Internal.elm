module Vector28.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector28 a
...
unshift : a -> Vector28 a -> Vector29 a
