module Vector98.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector98 a
...
unshift : a -> Vector98 a -> Vector99 a
