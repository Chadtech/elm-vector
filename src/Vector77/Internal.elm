module Vector77.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
import Vector77.Internal exposing (Vector(..), VectorModel)
...
fromListWithDefault : a -> List a -> Vector77 a
...
unshift : a -> Vector77 a -> Vector78 a
