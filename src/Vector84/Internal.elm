module Vector84.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector84 a
...
unshift : a -> Vector84 a -> Vector85 a
