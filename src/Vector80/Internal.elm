module Vector80.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector80 a
...
unshift : a -> Vector80 a -> Vector81 a
