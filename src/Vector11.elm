...
{-| Try and turn an `Int` into an `Index`, returning `Nothing` if the `Int` is above the maximum index of this `Vector11 a` -}
...
{-| Make a `Vector11 a` from 11elements -}
...
push : a -> Vector11 a -> Vector12.Vector a
...
uncons : Vector11 a -> ( a, Vector10.Vector a )
...
cons : a -> Vector11 a -> Vector12.Vector a
