...
{-| Make a `Vector11 a` using a function that takes an `Int`, representing the index -}
...
{-| Make a `Vector11 a` filled with just one item repeated over and over again. -}
repeat : a -> Vector11 a
repeat a =
    { n0 = a
    , n1 = a
...
{-| Make a `Vector11 a` from 11 elements -}
