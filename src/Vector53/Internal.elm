module Vector53.Internal exposing
    ( Vector(..)
    , VectorModel
    )
...
fromListWithDefault : a -> List a -> Vector53 a
...
unshift : a -> Vector53 a -> Vector54 a
